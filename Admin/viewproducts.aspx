<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin1.master" AutoEventWireup="true" CodeFile="viewproducts.aspx.cs" Inherits="Admin_viewproducts" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder2" Runat="Server">
    ...
    margin-top: -47px;" runat="server" AutoGenerateColumns="False" CellPadding="3" Width="1494px" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" Height="323px" OnRowCommand="GridView1_RowCommand" CssClass="auto-style1">
        <Columns>
