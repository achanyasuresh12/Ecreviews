...
public partial class Admin_negativedataset : System.Web.UI.Page
{
    ...
    private void InsertExcelRecords(string FilePath)
    {
        ...
        Query = string.Format("Select [words] FROM [{0}]", "settttt$");
        ...
        objbulk.DestinationTableName = "positivewords";
        //Mapping Table column  
        objbulk.ColumnMappings.Add("words", "positivewords");
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        if (FileUpload1.HasFile)
        {
            ...
            string excelPath = Server.MapPath("~/Sentimentaldataset/") + CurrentFilePath; FileUpload1.SaveAs(excelPath);
